...
class AuthService {
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // MÉTHODES D'AUTHENTIFICATION ALTERNATIVES - COMMENTÉES
  // ══════════════════════════════════════════════════════════════════════════════
  // Les méthodes login() [email/password], register() et loginWithGoogle()
  // ont été retirées dans la branche feat/github-branch-repo-automation.
  // Pour les restaurer, référez-vous au commit précédent ou à la branche master.
  //
  // Méthodes disponibles dans les versions précédentes :
  // - Future<UserEntity> login(String email, String password)
  // - Future<UserEntity> register(String name, String email, String password)
  // - Future<UserEntity> loginWithGoogle()
  // ══════════════════════════════════════════════════════════════════════════════

  /// Authentification via GitHub OAuth (méthode active)
