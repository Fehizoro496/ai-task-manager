  ...
  return (
    <>
      ...
      <main className="flex-1 px-8 py-7">
        <section className="relative overflow-hidden rounded-xl border border-line bg-bg-elevated shadow-1">
          ...
          <div className="relative grid gap-6 px-7 py-6 md:grid-cols-[1.4fr_1fr] md:items-center">
            <div>
              <p className="text-[11.5px] font-semibold uppercase tracking-[0.18em] text-brand-ink]">
                Bonjour
              </p>
              ...
              <p className="mt-2 max-w-[560px] text-[14.5px] leading-relaxed text-ink-2">
                Vous avez{" "}
        ...
        <section className="mt-7">
          ...
          {loading ? (
            <div className="mt-6 flex items-center justify-center gap-2 text-[13px] text-ink-3">
              <Loader2 className="h-4 w-4 animate-spin" />
              Chargement…
            </div>
          ) : projects.length === 0 ? (
            <div className="mt-4 rounded-lg border border-dashed border-line-strong bg-bg-elevated p-8 text-center text-[13px] text-[hsl(var(--ink-3))]">
              ...
              {projects.slice(0, 8).map((p) => {
                ...
                return (
                  <button
                    ...
                    className="group relative w-full overflow-hidden rounded-lg border border-line bg-bg-elevated p-5 text-left shadow-1 transition-all hover:-translate-y-0.5 hover:shadow-2"
                  >
                    <div
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <ChevronRight className="h-4 w-4 text-ink-4 opacity-0 transition-opacity group-hover:opacity-100" />
                    </div>
                    <div className="mt-4">
                      <div className="font-display text-[16.5px] font-semibold tracking-tight">
                        {p.name}
                      </div>
                      <p className="mt-1 line-clamp-2 text-[12.5px] leading-snug text-ink-3">
                        {p.description ?? "—"}
                      </p>
                    </div>
                  </button>
...
function Kpi({
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-line bg-bg-elevated p-5 shadow-1">
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 text-[12px] font-medium text-ink-2">
          {label}
        </div>
      </div>
    </div>
